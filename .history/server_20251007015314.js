// ============== SERVIDOR BACKEND PARA VINTEX CLINIC (CON CREACIÓN DE CLIENTES) ==============
...
app.post('/api/citas', async (req, res) => {
    ...
    try {
        // --- LÓGICA PARA MANEJAR CLIENTES NUEVOS ---
        if (new_client_name && new_client_dni) {
            // 1. Verificar si el cliente ya existe por DNI para evitar duplicados
