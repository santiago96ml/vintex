// ============== SERVIDOR BACKEND PARA VINTEX CLINIC (CON LISTA DE CLIENTES) ==============
 ...
 * @desc    Obtiene todos los datos para inicializar la aplicación: doctores, citas y clientes.
 */
app.get('/api/initial-data', async (req, res) => {
    console.log("Petición recibida: GET /api/initial-data");
    try {
        // Obtenemos todos los datos en paralelo para mayor eficiencia
...
app.post('/api/citas', async (req, res) => {
    ...
    // Asegurarse de que los campos obligatorios no son nulos
